...
export default function RoundButton({
	...
	return (
		<Link
			...
			href={href}>
			<Rounded
				className="py-[6px] group-hover:glow-yellow-hover"
				backgroundColor={bgcolor || "#fbc10d"}>
				<p
					className="z-10 px-[10px] ml-[15px] py-[6px] text-darkBlue font-semibold"
					style={style || { color: "#19254c" }}>
					{title}
				</p>
				<div
					...
					<ArrowUpRight
						strokeWidth={1.5}
						size={30}
						className="scale-[0] group-hover:scale-[1] text-darkBlue"
					/>
				</div>
			</Rounded>
		</Link>
