...
export default function Ready() {
	...
	const phrase = ["Ready", "to transform", "your preparation"];
		...
		<section
			...
			<div className="w-full h-full flex justify-center gap-[50px] items-center flex-col">
				<div className="flex flex-col gap-[10px]">
					<h1 className="text-[290px] leading-[230px] lg:text-[220px] lg:leading-[170px] md:text-[180px] md:leading-[140px] sm:text-[120px] sm:leading-[90px] xm:text-[80px] xm:leading-[60px] tracking-[-2.5px] text-center font-bold font-FoundersGrotesk text-darkBlue uppercase pointer-events-none">
				...
				<div className="flex flex-col  items-center gap-[10px]">
					...
					<p className="text-[20px] font-NeueMontreal text-darkBlue">OR</p>
					<div className="flex items-center justify-between bg-transparent cursor-pointer rounded-full group border-2 border-darkBlue">
						<Link
							...
							<Rounded
								...
								<p className="z-10 px-[10px] ml-[15px] py-[6px] group-hover:text-darkBlue text-offWhite">
									hello@gestalty.com
								</p>
